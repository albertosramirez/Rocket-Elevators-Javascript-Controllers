...
const { Column, Elevator, panelButton, floorButton, Door } = require('./residential_controller.js')
...
describe('ResidentialController', () => {
    ...
    describe("Column's attributes and methods", () => {
        ...
        it('Instantiates a Column with valid attributes', () => {
            ...
            expect(column.panelButtonList.length).toEqual(18)
            expect(column.panelButtonList[0] instanceof panelButton).toBe(true)
        })
    ...
    describe("Elevator's attributes and methods", () => {
        ...
        it('Instantiates an Elevator with valid attributes', () => {
            ...
            expect(elevator.floorButtonList.length).toEqual(10)
    ...
    describe("panelButton's attributes", () => {
        const panelButton = new panelButton(1, 1, 'up')

        it('Instantiates a panelButton with valid attributes', () => {
            expect(panelButton instanceof panelButton).toBe(true)

            expect(panelButton.ID).toEqual(1)
            expect(panelButton.status).not.toBeNull()
            expect(panelButton.floor).toEqual(1)
            expect(panelButton.direction).toEqual('up')

        })
    })

    describe("floorButton's attributes", () => {
        const floorButton = new floorButton(1, 1)

        it('Instantiates a floorButton with valid attributes', () => {
            expect(floorButton instanceof floorButton).toBe(true)

            expect(floorButton.ID).toEqual(1)
            expect(floorButton.status).not.toBeNull()
            expect(floorButton.floor).toEqual(1)
        })
    })
